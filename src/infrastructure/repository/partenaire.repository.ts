...
import { Partenaire } from "../../../generated/prisma/client";
...
export class PartenaireRepository implements WithCache {
  ...
  public async loadCache() {
    ...
    const listePartenaires = await this.prisma.client.partenaire.findMany();
  ...
  public async delete(cms_id: string) {
    await this.prisma.client.partenaire.delete({
  ...
  public async upsert(partenaire: PartenaireDefinition) {
    ...
    await this.prisma.client.partenaire.upsert({
      where: {
